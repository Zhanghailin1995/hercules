...
import org.hercules.Closure;
import org.hercules.Status;
...
public final class RpcUtils {
    ...
    /**
     * Default hercules closure executor pool minimum size, CPUs by default.
     */
    public static final int MIN_RPC_CLOSURE_EXECUTOR_POOL_SIZE = SystemPropertyUtil.getInt(
            "hercules.rpc.closure.threadpool.size.min",
            Utils.cpus());

    /**
     * Default hercules closure executor pool maximum size.
     */
    public static final int MAX_RPC_CLOSURE_EXECUTOR_POOL_SIZE = SystemPropertyUtil.getInt(
            "hercules.rpc.closure.threadpool.size.max",

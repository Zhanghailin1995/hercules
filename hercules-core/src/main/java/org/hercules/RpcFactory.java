...
public interface RpcFactory {
    ...
    default ConfigHelper<RpcClient> defaultClientConfigHelper(final RpcOptions opts) {
        return null;
    }

    @SuppressWarnings("unused")
    default ConfigHelper<RpcServer> defaultServerConfigHelper(final RpcOptions opts) {
        return null;
    }

...
import org.hercules.util.Copiable;
...
public class Status implements Copiable<Status> {
    ...
    public Status(RpcError rpcError, String fmt, Object... args) {
        this.state = new State(rpcError.getNumber(), String.format(fmt, args));
    }
    ...
    public String toString() {
        if (isOk()) {
            ...
            return "Status[" + this.state.code + "<" + this.state.code + ">: " + this.state.msg
                   + "]";
        }
    }
